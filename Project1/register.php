		    ...
		    <center>
		      ...
		      <div class="container">
		        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
		          ...
		          <form class="col s12" action="proses_regis.php" method="post">
		            <div class='row'>
		              <div class='col s12'>
		              </div>
		            </div>
		            ...
		            <div class='row'><left>
		              ...
		              <label for='nama'>Nama lengkap</label></left>
		              </div>

		            <label>Alamat</label>
			        <select class="browser-default" name="alamat" id="alamat" class="validate">
