...
<?php
 ...
 <!-- <tbody> -->
    ...
    <tr>
      ...
      <td>  
            <a href="edit.php?id=<?php echo $d['id_lapangan']; ?>&aksi=edit" class="btn-floating blue lighten-3"><i class="material-icons">mode_edit</i></a>
            <a href="#zoomlapangan" class="btn-floating blue lighten-2"><i class="material-icons">zoom_in</i></a>
            <a href="" class="btn-floating blue lighten-1"><i class="material-icons">delete</i></a>
