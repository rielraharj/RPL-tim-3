...
<head>
	...
	<center>	
		<form action="reglapprocess.php" method="post" id="reglapang">
			...
			Jumlah Lapangan:<br>
			<input type="number" name="jmllapang" id="jmllapang" required><br><br>
			
			Alamat Lapangan:<br>
			<textarea name="alamatlap" id="alamatlap" rows="10" cols="20" form="reglapang" required>
				
			</textarea><br><br>
			
			Harga Lapangan:<br>
			Rp.<input type="text" name="hrglapang" id="hrglapang" required>/jam<br><br>
